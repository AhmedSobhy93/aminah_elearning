...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .formLogin(form -> form.loginPage("/profile/login").defaultSuccessUrl("/", true).failureUrl("/profile/login?error").permitAll())
                .logout(logout -> logout.logoutUrl("/profile/logout").logoutSuccessUrl("/profile/login?logout")
